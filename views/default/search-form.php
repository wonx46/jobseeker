...
<div class="well">
    <div class="row">
        ...
        <div class="col-md-12" >
            <input type="hidden" name="<?php _e($csrf_key); ?>" value="<?php _e($csrf_token); ?>">
            <a style="width: 300px;margin: 0 auto;" type="button" class="btn btn-info btn-lg btn-block" href="<?php _e(BASE_URL); ?>jobs/new" <?php if (ALLOW_JOB_POST == INACTIVE) { echo 'disabled'; } ?>>
