...
define('SMTP_USER', 'wonx.shop@gmail.com');  
define('SMTP_PASS', 'ulet bulu');  
define('SMTP_PORT', 465);  
define('SMTP_SECURE', 'ssl');

// APPLICATION URL PATHS
define('BASE_URL','http://35.197.130.228/jobseeker/'); // always include the trailing slash at the end
